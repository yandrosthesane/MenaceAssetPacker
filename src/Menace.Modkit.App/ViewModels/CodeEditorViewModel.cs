...
public sealed class CodeEditorViewModel : ViewModelBase, ISearchableViewModel
{
    ...
    /// Uses Unicode box-drawing for the logo. Comments styled with our theme color.
    /// </summary>
    ...
    ╚═══════════════════════════════════════════════════════════════════════════╝
          ...
          Select a script file or create a new script to get started.
    ...
    TIPS:
      ...
      • Lua scripts run in the game's scripting environment
      • C# scripts are compiled and loaded as mods
      • Use the API Reference panel to explore available functions
      • Check the Lua Docs button for full documentation
